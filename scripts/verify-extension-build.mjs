...
if (manifest.version !== '1.2.0') {
  throw new Error(`Expected release version 1.2.0, received ${manifest.version}.`);
}
...
console.log('Extension build verified: V1.2.0, minimal permissions, self-contained content script, and valid Manifest V3 manifest.');
