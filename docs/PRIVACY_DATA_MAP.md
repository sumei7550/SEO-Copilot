...
|Anonymous analytics ID|Generated by Mixpanel SDK on the website or extension|Aggregate product usage and conversion analysis|Mixpanel persistence on the client; no page content|Anonymous event names and limited properties are sent to Mixpanel|No sale or advertising use|
...
- Data transmitted off-device: Anonymous analytics events and, only after an explicit AI Fix request, necessary page context; basic scanning stays local.
- Remote code: No.
