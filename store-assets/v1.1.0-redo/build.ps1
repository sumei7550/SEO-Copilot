...
function MakeSlide($data,$n){
  ...
  $browser=[Drawing.Rectangle]::new(474,54,760,676);Round $g $browser 14 [Drawing.Color]::White [Drawing.Color]::FromArgb(205,211,229);$shadow=[Drawing.Pen]::new([Drawing.Color]::FromArgb(70,35,38,83),8);$g.DrawRectangle($shadow,478,58,752,668);$shadow.Dispose();ImageContain $g (Join-Path $src $data.scene) ([Drawing.Rectangle]::new(474,54,760,676))
...
$slides=@(
 @{title='Scan any page instantly';desc="Run a fast SEO audit on the page you're viewing and see what needs attention.";bullets=@('One-click page audit','On-page and technical SEO checks','Works directly in Chrome');scene='01-direct.png';file='01-scan-any-page.png'},
 @{title='See your SEO score';desc="Get an instant SEO score, issue summary, and severity overview for the page you're viewing.";bullets=@('SEO score out of 100','Page health at a glance','Clear issue summary');scene='02-direct.png';file='02-seo-score.png'},
 @{title='Find SEO issues that matter';desc="Understand what's affecting your page and get practical recommendations you can act on.";bullets=@('Prioritized SEO issues','Clear impact explanations','Recommended next steps');scene='03-direct.png';file='03-find-seo-issues.png'},
 @{title='Improve SEO content with AI';desc="Get page-aware AI suggestions for titles and meta descriptions without leaving your browser.";bullets=@('AI title suggestions','AI meta description suggestions','Before and after comparison');scene='04-direct.png';file='04-ai-seo-fix.png'},
 @{title='Compare, copy, and re-scan';desc="Choose the best AI suggestion, copy it, update your page, and scan again.";bullets=@('Compare multiple AI suggestions','Copy your preferred option','Re-scan after updates');scene='05-direct.png';file='05-copy-and-rescan.png'}
)
